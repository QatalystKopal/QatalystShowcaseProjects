                ...
                {project.sdgs.map((sdg) => (
                  ...
                  >
                    {sdg.image ? (
                      ...
                      <div
                        className="w-full aspect-square flex items-center justify-center rounded-lg shadow-md text-white font-bold text-2xl"
                        style={{ background: SDG_COLORS[sdg.number] ?? "#6b7280" }}
                      >
                        {sdg.number}
                      </div>
                    )}
                    <span className="mt-2 text-[11px] font-semibold text-gray-700 leading-tight">SDG {sdg.number}</span>
                  </div>
                ))}
              </div>
            </div>
