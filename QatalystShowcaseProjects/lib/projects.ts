...
export const projects: Project[] = [
  // ─── PROJECT 1: VCS 4782 ───────────────────────────────────────────────────
  {
    ...
    methodologyBreakdown: [
      { label: "CIW (Peat)", pct: 45, color: "#F86501" },
      { label: "RWE (Peat)", pct: 27, color: "#0D9488" },
      { label: "APD (REDD)", pct: 13, color: "#1F2937" },
      { label: "Forest Growth (Removal)", pct: 15, color: "#9CA3AF" },
    ],
    registry: "Verra VCS",
    vcsVersion: "VCS 4.7",
    ...
    sdgs: [
      { number: 1, label: "No Poverty", image: "/sdgs/sdg-1.svg" },
      { number: 5, label: "Gender Equality", image: "/sdgs/sdg-5.svg" },
      { number: 8, label: "Decent Work & Economic Growth", image: "/sdgs/sdg-8.svg" },
      { number: 13, label: "Climate Action", image: "/sdgs/sdg-13.svg" },
      { number: 15, label: "Life on Land", image: "/sdgs/sdg-15.svg" },
    ],
    a62Eligible: false,
    images: {
      hero: "/south-barito.jpg",
      thumbnail: "/south-barito.jpg",
    },
    documents: [
